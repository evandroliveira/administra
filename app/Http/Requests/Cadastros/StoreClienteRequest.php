    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'email' => [
                'required',
                'email',
                Rule::unique('clientes', 'email')->where(fn ($query) => $query->where('empresa_id', $empresaId)),
            ],
            ...
            'cpf_cnpj' => [
                ...
                'string',
                'max:20',
                Rule::unique('clientes', 'cpf_cnpj')->where(fn ($query) => $query->where('empresa_id', $empresaId)),
            ],
